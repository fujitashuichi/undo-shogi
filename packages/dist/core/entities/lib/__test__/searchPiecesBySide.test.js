...
describe("lib/searchPiecesBySide", () => {
    describe("先手の駒を全て取得する", () => {
        it("returnPositionsの場合", () => {
            ...
            expect(searchPiecesBySide.returnPositions(board, "Sente")).toEqual(expect.arrayContaining(expected));
            expect(expected).toEqual(expect.arrayContaining(searchPiecesBySide.returnPositions(board, "Sente")));
        });
        it("returnInstancesの場合", () => {
            const board = new Board(hirateSquares);
            expect(searchPiecesBySide.returnInstances(board, "Sente")).toEqual(expect.arrayContaining([
    ...
    describe("後手の駒を全て取得する", () => {
        it("returnPositionsの場合", () => {
            ...
            expect(searchPiecesBySide.returnPositions(board, "Gote")).toEqual(expect.arrayContaining(expected));
            expect(expected).toEqual(expect.arrayContaining(searchPiecesBySide.returnPositions(board, "Gote")));
        });
        it("returnInstancesの場合", () => {
            const board = new Board(hirateSquares);
            expect(searchPiecesBySide.returnInstances(board, "Gote")).toEqual(expect.arrayContaining([
...
//# sourceMappingURL=searchPiecesBySide.test.js.map