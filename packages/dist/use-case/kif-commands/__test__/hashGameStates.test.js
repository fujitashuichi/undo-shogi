...
describe("hashGameStates", () => {
    it("同じ盤面は同じハッシュになる", () => {
      ...
      手数----指手---------消費時間--
        ...
        8 詰み
    `);
        const hashed_1 = hashGameStates(executeActions(actions, initialGameState_Hirate));
        const hashed_2 = hashGameStates(executeActions(actions, initialGameState_Hirate));
        vitest_checkArray.sameArray(hashed_1, hashed_2);
    });
});
//# sourceMappingURL=hashGameStates.test.js.map